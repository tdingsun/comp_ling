...
def load_dataset(train_fn, test_fn, tokenizer, batch_size, model_type):
    """
    ...
    if model_type == "transformer":
        ...
        with open(test_fn, 'r') as f:
            for line in f:
                ...
                test_inputs.append(tokenizer.encode(input_seq, pad_to_max_length=True))
                test_labels.append(tokenizer.encode(label, pad_to_max_length=True))
